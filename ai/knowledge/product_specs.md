...
## Overview
ECOVAL produces eco-friendly heritage breeze blocks (gạch bông gió di sản) engineered from upcycled multi-layer plastic waste (MLP), rice husk (vỏ trấu), and coconut coir (xơ dừa) fibers.
