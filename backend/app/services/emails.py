...
def send_bilingual_confirmation_email(to_email: str, recipient_name: str, form_type: str, form_data: dict):
    ...
    if form_type == "epr_partner":
        subject = "ECOVAL: Xác nhận Đăng ký Tư vấn Đối tác EPR / EPR Partnership Consultation Confirmation"
        body_vi = f"""
        Chào {recipient_name},
        
        Cảm ơn công ty {form_data.get('company_name')} đã đăng ký tư vấn giải pháp xử lý rác thải nhựa EPR cùng ECOVAL.
        ...
        Đội ngũ ECOVAL sẽ liên hệ với bạn trong vòng 24-48 giờ làm việc để trao đổi về quy trình thu gom, tái chế và cấp chứng chỉ ESG/EPR điện tử.
        
        Trân trọng,
        Đội ngũ ECOVAL Circular Materials.
        """
        body_en = f"""
        Dear {recipient_name},
        
        Thank you, {form_data.get('company_name')}, for registering for the EPR plastic waste solution consultation with ECOVAL.
        ...
        The ECOVAL team will contact you within 24-48 business hours to discuss the collection, recycling process, and the issuance of your digital ESG/EPR certificate.
        
        Best regards,
        The ECOVAL Circular Materials Team.
        """
        
    elif form_type == "green_project":
        subject = "ECOVAL: Xác nhận Đăng ký Tư vấn Công trình Xanh / Green Project Design Consultation Confirmation"
        body_vi = f"""
        Chào {recipient_name},
        
        Cảm ơn bạn đã đăng ký tư vấn giải pháp gạch bông gió di sản ECOVAL cho công trình xanh của mình.
        ...
        Đội ngũ kỹ thuật của ECOVAL sẽ liên hệ để gửi các phương án thiết kế thông gió thụ động và cách nhiệt phù hợp nhất với dự án của bạn.
        ...
        Thank you for requesting a consultation on ECOVAL's heritage breeze block solutions for your green project.
        ...
        ECOVAL's engineering team will reach out to provide you with custom passive ventilation and thermal insulation design proposals tailored to your project.
        ...
        subject = "ECOVAL: Xác nhận Đăng ký Thu gom Nguyên liệu / Raw Material Supplier Registration Confirmation"
        ...
        Cảm ơn bạn đã đăng ký trở thành đối tác thu gom cung ứng nguyên liệu thô (nhựa đa lớp MLP) cho dự án ECOVAL.
        ...
        Chúng tôi sẽ liên hệ để hướng dẫn phương thức đóng gói, phân loại và lên lịch gom hàng hoặc tiếp nhận tại xưởng ECOVAL.
        ...
        Thank you for registering to supply raw materials (multi-layer plastic MLP) to the ECOVAL project.
        ...
        We will contact you to explain the packaging and sorting guidelines, and schedule collection or drop-off at the ECOVAL workshop.
            ...
            <body>
                <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
                    <div style="border-bottom: 2px solid #059669; padding-bottom: 10px;">
                        <h2 style="color: #059669;">ECOVAL Circular</h2>
                    </div>
                    ...
                    <div style="margin-top: 30px; font-size: 12px; color: #777; border-top: 1px solid #eee; padding-top: 10px;">
                        Email này được gửi tự động từ hệ thống ECOVAL. Vui lòng không trả lời trực tiếp email này.
                        <br/>
                        This is an automated email from ECOVAL. Please do not reply directly.
                    </div>
                </div>
            </body>
        </html>
