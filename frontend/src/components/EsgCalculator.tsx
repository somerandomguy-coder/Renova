...
export default function EsgCalculator({ lang }: EsgCalculatorProps) {
  ...
  const fetchEprCalculations = async (volume: number, price: number) => {
    try {
      ...
      setEprResult({
        ...
        ecoval_bricks_needed: bricksNeeded,
  ...
  return (
    <section id="tinh-toan" ref={sectionRef} className="light-section py-20">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-3 px-2">
                  <div className="flex flex-col gap-0.5">
                    ...
                    <span className="text-sm font-semibold text-brand-text-primary dark:text-white">{formatNumber(eprResult.ecoval_bricks_needed)}{t.bricksUnit}</span>
                  </div>
                  <div className="flex flex-col gap-0.5">
