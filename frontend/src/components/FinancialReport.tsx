...
const translations = {
  vi: {
    ...
    brickRev: "Doanh Thu Bán Gạch",
    eprFee: "Doanh Thu Dịch Vụ EPR",
    circularAdvantage: "Lợi Thế Tuần Hoàn: Nhựa MLP thô (40%) có giá vốn 0 VNĐ và tạo ra thu nhập từ phí EPR, hạ thấp giá thành.",
    cogsDetailTitle: "Chi Tiết Định Mức Nguyên Vật Liệu (BOM)",
    ...
    basis: "Căn Cứ & Nguồn",
    mlpDesc: "Trực tiếp từ đối tác FMCG (kèm phí dịch vụ EPR)",
    hdpeDesc: "Khảo sát giá đại lý thu gom ve chai",
    huskDesc: "Hợp đồng thu mua tại ĐBSCL, nguồn cung ổn định",
    peDesc: "Giá nội địa phụ gia liên kết chéo polymer",
    totalBom: "TỔNG BÓC TÁCH BOM",
    bomAdv: "Tối ưu chi phí nhờ loại bỏ hoàn toàn nhựa Epoxy",
    opexTitle: "Chi Phí Vận Hành Hàng Tháng (OPEX)",
    opexTableHead: ["Hạng Mục OPEX", "Chi Phí/Tháng", "Diễn Giải & Căn Cứ"],
    labor: "Nhân Công Trực Tiếp",
    laborDesc: "3 công nhân × 8.000.000 VNĐ (sản xuất, ép nhiệt)",
    utility: "Điện & Tiện Ích",
    utilityDesc: "Dự toán tiêu thụ điện cho nồi gia nhiệt 200°C và máy ép",
    rent: "Thuê Nhà Xưởng",
    rentDesc: "Khoảng 150m² tại các cụm công nghiệp vệ tinh",
    treatment: "Chi Phí Xử Lý Rác MLP",
    treatmentDesc: "Vận chuyển & băm nhỏ 6.000 kg MLP × 1.500 VNĐ/kg",
    depreciation: "Khấu Hao Máy Móc",
    depreciationDesc: "Khấu hao đường thẳng: CapEx 260tr trong 60 tháng",
    totalOpex: "TỔNG OPEX HÀNG THÁNG",
    cogsGpTitle: "Giá Vốn Hàng Bán (COGS) & Lợi Nhuận Gộp (GP)",
    totalCogs: "Tổng Chi Phí (COGS)",
    brickSales: "Doanh Thu Bán Gạch",
    eprSales: "Doanh Thu Dịch Vụ EPR",
    totalRev: "Tổng Doanh Thu (TR)",
    totalCost: "Tổng Chi Phí Sản Xuất (TC)",
